...
/// Intrinsic angular momentum of a particle that denotes the amount of symmetric faces it has in a
/// turn of 360º. Due to the scale at which they are presented, spins are not equivalent to
